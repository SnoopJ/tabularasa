...
Version 2.0 represents a large change in both Starbound and Tabula Rasa, and as such, Tabula Rasa 2.0 is NOT backwards compatible with previous versions.  V2.1 should work for mods that depend on V2.0.

== CHANGELOG ==
2.1 - update to 'Enraged,' fixed bug where filter butters got added more than once
